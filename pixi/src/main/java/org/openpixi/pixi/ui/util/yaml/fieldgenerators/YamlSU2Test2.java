...
import org.openpixi.pixi.physics.fields.fieldgenerators.SU2Test2;
...
public class YamlSU2Test2 {
	...
	/**
	 * Number of oscillations within pulse.
	 */
	 ...
	 */
	public SU2Test2 getFieldGenerator() {
		...
		return new SU2Test2(dirArray, posArray, aSpatialArray, aColorArray, a, sigma, waveCount);
	}
}
