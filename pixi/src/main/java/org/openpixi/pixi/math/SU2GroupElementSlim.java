 ...
 *
 */
public class SU2GroupElementSlim implements GroupElement {
	 ...
	 */
	public SU2GroupElementSlim(double a, double b, double c, double d) {
	 ...
	 */
	public SU2GroupElementSlim(SU2GroupElementSlim matrix)
	{
		this();
		this.set(matrix);
	}
	...
	public GroupElement add(GroupElement arg) {
		SU2GroupElementSlim b = (SU2GroupElementSlim) this.copy();
		b.addAssign(arg);
		return b;
	}

	public void addAssign(GroupElement arg) {
		SU2GroupElementSlim a = (SU2GroupElementSlim) arg;
		e0 += a.e0;
		e1 += a.e1;
		e2 += a.e2;
		e3 += a.e3;
	...
	public void multAssign(GroupElement arg) {
		double f0, f1, f2;
		double ae0 = ((SU2GroupElementSlim) arg).e0;
		double ae1 = ((SU2GroupElementSlim) arg).e1;
		double ae2 = ((SU2GroupElementSlim) arg).e2;
		double ae3 = ((SU2GroupElementSlim) arg).e3;
		f0 = e0;
		f1 = e1;
		f2 = e2;
	...
	public AlgebraElement getAlgebraElement()
	{
		...
		if(norm < 1.E-15) {
			//return new SU2AlgebraElementSlim();
			return this.proj();
		} else {
	...
	public GroupElement copy() {
		return new SU2GroupElementSlim(e0, e1, e2, e3);
	}
	 ...
	 */
	public SU2GroupElementSlim inv() {
		double n = computeParameterNorm();
		SU2GroupElementSlim v = (SU2GroupElementSlim) this.adj();
