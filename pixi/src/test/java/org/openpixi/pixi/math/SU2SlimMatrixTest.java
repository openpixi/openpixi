...
public class SU2SlimMatrixTest {
	...
	public void testGetterAndSetter() {
		...
		SU2GroupElementSlim firstMatrix = new SU2GroupElementSlim(vec[0], vec[1], vec[2], vec[3]);
		SU2GroupElementSlim secondMatrix = new SU2GroupElementSlim();
		for (int i = 0; i < 4; i++) {
	...
	public void testUnitarity() {
		 ...
		 */
		SU2GroupElementSlim matrix = createRandomSU2Matrix();
	...
	public void testAdditionAndSubtraction() {
		...
		/*
			Create two matrices.
		 */
		SU2GroupElementSlim a = new SU2GroupElementSlim();
		SU2GroupElementSlim b = new SU2GroupElementSlim();
		for (int i = 0; i < 4; i++) {
			a.set(i, aVec[i]);
			b.set(i, bVec[i]);
		}
		 ...
		 */
		SU2GroupElementSlim r1 = (SU2GroupElementSlim) a.add(b);
		SU2GroupElementSlim r2 = (SU2GroupElementSlim) a.sub(b);
	...
	public void testBasicMatrixConversionStuff() {
		...
		/*
			Create unit matrix.
		 */
		SU2GroupElementSlim a = new SU2GroupElementSlim(1.0, 0.0, 0.0, 0.0);
		 ...
		 */
		SU2GroupElementSlim b = new SU2GroupElementSlim(0.0, 1.0, 0.0, 0.0);
		 ...
		 */
		SU2GroupElementSlim c = new SU2GroupElementSlim(0.0, 0.0, 1.0, 0.0);
		...
		/*
			Create Pauli y matrix times i.
		 */
		SU2GroupElementSlim d = new SU2GroupElementSlim(0.0, 0.0, 0.0, 1.0);
	...
	public void testMultiplication() {
		SU2GroupElementSlim a = createRandomSU2Matrix();
		SU2GroupElementSlim b = createRandomSU2Matrix();
	...
	public void testScalarMultiplication() {
		...
		for (int t = 0; t < numberOfTests; t++) {
			 ...
			 */
			SU2GroupElementSlim m1 = createRandomSU2Matrix();
			...
			m1 = (SU2GroupElementSlim) m1.mult(rand);
	...
	public void testAct() {
		...
		for (int t = 0; t < numberOfTests; t++) {
			 ...
			 */
			SU2AlgebraElementSlim f1 = createRandomSU2AlgebraElementSlim();
			...
			/*
				Do act method
			 */
			SU2AlgebraElementSlim f2 = (SU2AlgebraElementSlim) f1.act(m1);
			f1.actAssign(m1);
	...
	public void testPow() {
		...
		for (int i = 0; i < 10; i++) {
			...
			SU2GroupElementSlim m1 = createRandomSU2MatrixCloseToUnitMatrix(0.5);
			Array2DRowFieldMatrix<Complex> mm1 = convertToMatrix(m1);

			// Test integer powers
			SU2GroupElementSlim m2 = (SU2GroupElementSlim) m1.pow(2);
			...
			SU2GroupElementSlim m3 = (SU2GroupElementSlim) m1.pow(x);
			SU2GroupElementSlim m4 = (SU2GroupElementSlim) m3.pow(1.0 / x);
	...
	public void testInv() {
		...
		SU2GroupElementSlim m = new SU2GroupElementSlim();
		for (int i = 0; i < 3; i++) {
			double r = Math.random() - 0.5;
			m.set(i, r);
		}

		SU2GroupElementSlim m2 = m.inv();

		SU2GroupElementSlim m3 = (SU2GroupElementSlim) m.mult(m2);
	...
	private SU2GroupElementSlim createRandomSU2MatrixCloseToUnitMatrix(double x) {
		double[] vec = new double[4];
		vec[0] = Math.random() * x;
		...
		SU2GroupElementSlim m = new SU2GroupElementSlim(vec[0], vec[1], vec[2], vec[3]);
		Assert.assertEquals(m.computeParameterNorm(), 1.0, accuracy);

		return m;
	}

	private SU2GroupElementSlim createRandomSU2Matrix() {
		/*
			Create random SU2 matrix.
		 */
		double[] vec = new double[4];
	...
	private SU2AlgebraElementSlim createRandomSU2AlgebraElementSlim() {
	...
	private Array2DRowFieldMatrix<Complex> convertToMatrix(AlgebraElement arg) {
		...
		SU2AlgebraElementSlim input = (SU2AlgebraElementSlim) arg;
	...
	private Array2DRowFieldMatrix<Complex> convertToMatrix(GroupElement arg) {
		...
		SU2GroupElementSlim input = (SU2GroupElementSlim) arg;
